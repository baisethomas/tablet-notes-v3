...
protocol SupabaseServiceProtocol {
    ...
    func getSignedUploadURL(for fileName: String, contentType: String, fileSize: Int, sermonLocalId: UUID?) async throws -> (uploadUrl: URL, path: String, upsert: Bool)
    ...
    func uploadAudioFile(at localUrl: URL, to signedUploadUrl: URL, upsert: Bool) async throws
